...
function renderEditor() {
  // use the common elements you use in each test to create a render function
  // this saves getBy duplication
  ...
  // return certain elements you'll need for assertions
  return {
    ...utils,
    submitButton,
    fakeUser,
